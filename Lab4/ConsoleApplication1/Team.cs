...
namespace ConsoleApplication1
{
    class Team : IDeepCopy
    {
        ...
        public void AddDefaults2()
        {
            ...
            persons[0] = new Person("Alex", "Smith", new DateTime(1990, 10, 10));
            persons[1] = new Researcher("Bob", "Lee", new DateTime(1985, 5, 12), "math", 5);
            persons[2] = new Researcher("Christian", "Jackson", new DateTime(1987, 7, 25), "physics", 0);
            persons[3] = new Person("Dmitry", "Ivanov", new DateTime(1993, 2, 28));
            persons[4] = new Programmer("Eve", "Carter", new DateTime(1991, 11, 5), 7, "biology");
